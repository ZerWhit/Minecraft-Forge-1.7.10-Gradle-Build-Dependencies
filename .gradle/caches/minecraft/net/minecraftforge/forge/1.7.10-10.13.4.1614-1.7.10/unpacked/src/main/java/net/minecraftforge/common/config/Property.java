...
public class Property
{
     ...
     * editable from both the download menu Mods list config screen and the in-game Mod Options config screen. When set to true the Property
     * will only be editable from the download menu Mods list config screen.
     */
