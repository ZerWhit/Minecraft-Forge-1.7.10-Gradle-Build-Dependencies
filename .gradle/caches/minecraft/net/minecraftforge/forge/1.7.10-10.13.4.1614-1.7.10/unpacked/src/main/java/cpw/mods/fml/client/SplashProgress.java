...
public class SplashProgress
{
    ...
    public static void start()
    {
        ...
        CrashReport report = CrashReport.func_85055_a(new Throwable()
        {
        ...
        thread = new Thread(new Runnable()
        {
            ...
            public void run()
            {
                ...
                while(!done)
                {
                    ...
                    // We use mutex to indicate safely to the download thread that we're taking the display global lock
                    // So the download thread can skip processing messages while we're updating.
                    // There are system setups where this call can pause for a while, because the GL implementation
                    // is trying to impose a framerate or other thing is occurring. Without the mutex, the download
