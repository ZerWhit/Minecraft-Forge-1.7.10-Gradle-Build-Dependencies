...
public class FMLTweaker implements ITweaker {
    ...
    public FMLTweaker()
    {
        System.setProperty("java.net.preferIPv4Stack", "true"); //Lets do this as early as possible. Vanilla does it in Main.download
        try
        {
    ...
    public String getLaunchTarget()
    {
        ...
        args.remove("--mods");
        return "net.minecraft.client.download.Main";
    }
